                ...
                <div class="row gy-4">
                    ...
                    <div class="col-xl-3 col-md-6 d-flex" data-aos="zoom-out">
                        <div class="service-item position-relative">
                            ...
                            <h4><a href="index.php" class="stretched-link">Male</a></h4>
                            <p>BCBI accepts people of the male gender.</p>
                        </div>
                    </div>
                    <!-- End Service Item -->
                    ...
                    <div class="col-xl-3 col-md-6 d-flex" data-aos="zoom-out" data-aos-delay="400">
                        <div class="service-item position-relative">
                            <div class="icon"><i class=""></i></div>
                            <h4><a href="index.php" class="stretched-link">Junior High Level</a></h4>
                    ...
                    <div class="col-xl-3 col-md-6 d-flex" data-aos="zoom-out" data-aos-delay="600">
                        <div class="service-item position-relative">
                            <div class="icon"><i class=""></i></div>
                            <h4><a href="index.php" class="stretched-link">Age</a></h4>
                            <p>Must be between the age of 16 to 25 years old.</p>
                        </div>
                    </div>
                    <!-- End Service Item -->

                    <div class="col-xl-3 col-md-6 d-flex" data-aos="zoom-out" data-aos-delay="800">
                        <div class="service-item position-relative">
                            <div class="icon"><i class=""></i></div>
                            <h4><a href="index.php" class="stretched-link">Fit</a></h4>
                            <p>Physically, Mentally, and Spiritually fit.</p>
                        </div>
                    </div>
                    <!-- End Service Item -->
                    <div class="col-xl-3 col-md-6 d-flex" data-aos="zoom-out" data-aos-delay="1000">
                        <div class="service-item position-relative">
                            <div class="icon"><i class=""></i></div>
                            <h4><a href="index.php" class="stretched-link">In need</a></h4>
                            <p>Must be from a low income family.</p>
                        </div>
                    </div>
            ...
            <div class="container" data-aos="fade-up">
                ...
                <div class="section-header">
                    ...
                    <p>
                        ...
                        to give the best service to the poor and to offer as many souls to God and to be Blessed Virgin.<br> <br> In 19983, he receive the Ramon Magsaysay Award for his excellent Charity works in Korea and for the first time, he came in
