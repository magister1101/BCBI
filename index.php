    ...
    <main id="main">
        ...
        <section id="aboutBOC" class="aboutBOC" style="border: 1px solid grey; margin: 10%; border-radius: 25px">
            <div class="container" data-aos="fade-up">
                ...
                <div class="section-header">
                    <h2>About Brothers of Christ.</h2>
                    <p style="display: block; text-align: center;">
                        The Brothers of Christ is a religious congregation founded by Venerable Aloysius Schwartz, an American Missionary Priest in Seoul, Korea on May 10, 1981, to respond to the reality of poverty, suffering, and prevation of the poorest of the poor.
                    </p>
                </div>
                ...
                <div class="section-header">
                    <h2>Our Service</h2>
                    <p style="display: block; text-align: center;">
                        The congregation supervices and maintains a shelter and training program for the destitute and homelessness elderly people and young adults. They render various forms of assistance and service that include direct evangelization and values formation and
                        livelihood training, self help projects, and retreat activities.
                    </p>
                </div>

                <div class="section-header">
                    <h2>Spiritual Formation</h2>
                    <p><i class="bi bi-check2"></i>1 Year Aspirancy.</p>
                    <p><i class="bi bi-check2"></i>1 Year Postulancy.</p>
                    <p><i class="bi bi-check2"></i>1 Year Novitiate.</p>
                    <p style="display: block; text-align: justify;">
                        After 3 years of formation the borthers profess the religious vows of poverty , chastity, obedience, and service of the poor and a promise to pray an average of three hours a day in honor to the five wounds of Jesus. These vows are being renewed every
                        year at the end of the annual retreat.
                    </p>
                </div>
