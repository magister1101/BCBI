    ...
    <main id="main">
        ...
        <section id="about" class="about">
            <div class="container" data-aos="fade-up">
                ...
                <div class="containner" data-aos="fade-up">
                    <div class="section-header">
                        <h2>About Borthers of Christ congregation</h2>
                        <p style="display: block; text-align: center;">The Brothers of Christ is a religious congregation founded by Venerable Aloysius Schwartz, an American Missionary Priest in Seoul, Korea on May 10, 1981, to respond to the reality of poverty, suffering, and prevation of the poorest
                            of the poor.</p>
                    </div>
        ...
        <section id="services" class="services">
            <div class="container" data-aos="fade-up">
                ...
                <div class="row gy-5">
                    ...
                    <div class="col-xl-4 col-md-4" data-aos="zoom-in" data-aos-delay="300">
                    ...
                    <div class="col-xl-4 col-md-4" data-aos="zoom-in" data-aos-delay="300">
                        <div class="service-item">
                            <div class="img">
                                <img src="assets/img/bcbi/galery/sf.jpg" class="img-fluid" alt="">
                            </div>
                            <div class="details position-relative">
                                <div class="icon">
                                ...
                                <!-- Trigger/Open The Modal -->
                                <button id="modalbtn1" class="stretched-link"><h3>Spiritual Formation</h3></button>
                                ...
                                <p><i class="bi bi-check2"></i>After 3 years of formation the borthers profess the religious vows of poverty , chastity, obedience, and service of the poor and a promise to pray an average of three hours a day in honor to
                                    the five wounds of Jesus. These vows are being renewed every year at the end of the annual retreat.</p>
